...
df_ae_train_af <- cbind(y_train, intermediate_output_train)
# combine class and AE-derived validation features
df_ae_valid_af <- cbind(y_valid, intermediate_output_valid)
# combine class and AE-derived test features
df_ae_test_af <- cbind(y_test, intermediate_output_test)
